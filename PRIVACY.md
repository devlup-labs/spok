...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sans Password or Key (SPoK).
...
- __Website__ refers to Sans Password or Key (SPoK), accessible from [https://github.com/devlup-labs/spok](https://github.com/devlup-labs/spok)
...
- By email: devluplabs@iitj.ac.in